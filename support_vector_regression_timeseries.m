...
n = 1;  % Number of delays, I use the last n values of my variables to predict the price,
% including the last prices itself
NDT =100; % Number of tests
...
Ytr1 = Ytr';
% Training
svm = fitrsvm(Xtr1,Ytr1,'KernelFunction','polynomial','polynomialOrder', 2, 'KernelScale','auto','Standardize',true); %treinamento
